                ...
                if (e.key === 'Enter') {
                    ...
                    if (!commandStr) {
                        ...
                        if (baseCmd === 'clear') {
                            ...
                            document.querySelectorAll('.typing-line').forEach(el => el.style.display = 'none');
                    ...
                    const matches = availableCommands.filter(cmd => cmd.startsWith(currentVal.toLowerCase()));
